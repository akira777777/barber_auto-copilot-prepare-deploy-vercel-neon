...
import { SERVICES, BARBERS, PRODUCTS, TESTIMONIALS } from './constants';
import { 
  Phone, MapPin, Clock, Instagram, Send, Star, 
  ArrowRight, Check, ShoppingCart, Sparkle, Tag, 
    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-[#c5a059] selection:text-black">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-x-20 gap-y-12">
            {filteredServices.map((service) => (
              <div key={service.id} className="group flex justify-between items-start border-b-2 border-zinc-900 pb-8 hover:border-[#c5a059]/40 transition-colors cursor-pointer" onClick={() => setIsBookingOpen(true)}>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-end justify-between mb-24 gap-10">
            <div>
              ...
              <h3 className="text-6xl md:text-8xl font-black oswald uppercase tracking-tighter leading-none">The <span className="text-zinc-800" style={{ WebkitTextStroke: '2px #222' }}>Portfolio</span></h3>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {galleryImages.map((src, idx) => (
              <div 
                ...
                className="group relative aspect-[3/4] overflow-hidden bg-zinc-900 border-2 border-zinc-900 hover:border-[#c5a059] transition-all duration-500 cursor-none"
              >
                <img 
                  src={src} 
                  alt={`Work ${idx + 1}`} 
      ...
      {activeGalleryImage !== null && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/95 backdrop-blur-xl animate-in fade-in duration-300">
           ...
           <div className="max-w-4xl max-h-[85vh] p-4 relative group" onClick={(e) => e.stopPropagation()}>
              <img 
              ...
              <div className="absolute bottom-10 left-10 right-10 flex justify-between items-end">
                ...
                <div className="flex gap-4">
                  <a href="#" className="flex items-center gap-2 text-white/50 hover:text-[#c5a059] transition-colors text-xs font-black uppercase tracking-widest oswald">
              ...
              >
                ...
                <div className="p-6 flex-grow flex flex-col border-t border-zinc-900 bg-[#050505]">
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <div className="flex items-center space-x-1" onMouseLeave={() => setHoveredStars(prev => ({ ...prev, [product.id]: 0 }))}>
                      {[1, 2, 3, 4, 5].map((star) => {
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
             <div className="space-y-16">
                ...
                <div className="pt-10 border-t border-zinc-900 flex gap-6">
                   <a href="#" className="flex-1 bg-zinc-900 border border-zinc-800 text-white p-6 text-center oswald font-black uppercase tracking-widest hover:bg-[#c5a059] hover:text-black hover:border-[#c5a059] transition-all">Directions</a>
                   <a href="#" className="flex-1 bg-white text-black p-6 text-center oswald font-black uppercase tracking-widest hover:bg-[#c5a059] hover:text-black transition-all">Book Now</a>
                </div>
             </div>
      ...
      <footer className="bg-black py-20 border-t border-white/5 relative">
          ...
          <div>
            ...
            <ul className="space-y-4">
               {['About Us', 'Privacy Policy', 'Terms of Service', 'Career', 'Gift Cards'].map(item => (
                 <li key={item}><a href="#" className="text-zinc-400 hover:text-white transition-colors uppercase font-black oswald tracking-widest text-xs">{item}</a></li>
               ))}
            </ul>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-10 border-t border-zinc-900 pt-12">
          <div className="flex gap-10">
             <a href="#" className="text-zinc-700 hover:text-white transition-colors"><Instagram size={20} /></a>
             <a href="#" className="text-zinc-700 hover:text-white transition-colors text-xs font-black uppercase oswald tracking-widest">Twitter</a>
             <a href="#" className="text-zinc-700 hover:text-white transition-colors text-xs font-black uppercase oswald tracking-widest">Facebook</a>
          </div>
