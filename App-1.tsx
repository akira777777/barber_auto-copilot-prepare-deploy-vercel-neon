...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden selection:bg-[#c5a059] selection:text-black">
      ...
      {isCartOpen && <CartDrawer isOpen={isCartOpen} onClose={() => setIsCartOpen(false)} items={cart} onUpdateQuantity={handleUpdateQuantity} onRemove={handleRemoveFromCart} onCheckout={handleCheckout} />}
